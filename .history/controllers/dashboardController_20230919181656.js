...
class DashboardController {
  ...
  async pastReservations(req, res) {
    try {
      const pastReservations = await prisma.reservations.findMany({
        ...
        cursor: {
          id: req.params.myCursor == undefined ? 0 : +req.params.myCursor,
        },
      });
  ...
  async getTables(req, res) {
    try {
      console.log(req.params.myCursor=='undefined');
      const tables = await prisma.tables.findMany({
        ...
        cursor: {
          id: req.params.myCursor !=='undefined' ? +req.params.myCursor : undefined,
        },
      });
  ...
  async getPartnershipRequest(req, res) {
    try {
      const requests = await prisma.partnerRequest.findMany({
        ...
        cursor: {
          id:
            req.params.myCursor == undefined ? undefined : +req.params.myCursor,
        },
      });
