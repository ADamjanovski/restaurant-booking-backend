...
If there are no specific criteria or filters needed for your query, and you simply want to retrieve all restaurants and include their associated ratings, you can use the following simplified Prisma query:
...
const result = await prisma.restaurant.findMany({
  ...
  myCursor: req.query.myCursor === undefined ? undefined : req.query.myCursor,
});
      } else {
