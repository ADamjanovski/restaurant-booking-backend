...
const upload = multer({
  storage: storage,
  limits: {
    fileSize: 50 * 1024 * 1024, // Set the maximum file size limit (e.g., 50MB)
  },
});
...
router.get("/pastReservations/:id", (req, res) =>
...
router.get("/partnerRequests", (req, res) =>
  dashboardController.getPartnershipRequest(req, res)
);
router.get("/customerService" ,(req,res)=> dashboardController.
router.get("/:id", (req, res) => dashboardController.getCategories(req, res));
